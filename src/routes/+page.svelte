...
<div class="min-h-screen">
	...
	<header class="border-b border-shop-light bg-shop-mid/50 backdrop-blur-sm sticky top-0 z-10">
		<div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 flex items-center justify-between">
			<div class="flex items-center gap-3">
				...
				<span class="text-xs text-shop-muted font-mono hidden sm:block">plywood optimizer</span>
			</div>
	...
	<main class="mx-auto max-w-7xl px-4 py-6 sm:px-6">
		<div class="flex flex-col gap-6 lg:flex-row">
			<!-- Left panel: inputs -->
			<section aria-label="Piece configuration" class="w-full space-y-5 lg:w-80 lg:shrink-0">
				<SheetConfig />
			...
			<!-- Right panel: results -->
			<section aria-label="Layout results" class="min-w-0 flex-1">
				<LayoutResults />
			</section>
		</div>
	</main>
